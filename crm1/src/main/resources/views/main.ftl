    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll layui-left-menu">
            <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-street-view"></i><span
                                class="layui-left-nav">点餐专区</span> <span class="layui-nav-more"></span></a>
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-1"
                               data-tab="buy/index" target="_self"><i class="fa fa-tty"></i><span
                                        class="layui-left-nav">随便看看</span></a>
                        </dd>
                        <dd>
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-1"
                               data-tab="buy/myOrder" target="_self"><i class="fa fa-tty"></i><span
                                        class="layui-left-nav">我的订单</span></a>
                        </dd>
                    </dl>
                </li>
